...
import org.pizazz2.extraction.parser.mail.EmlParser;
...
public class EmlParserTest {
    ...
    public void testMain() throws DetectionException, UtilityException, ParseException {
        ...
        byte[] data = IOUtils.toByteArray(IOUtils.getResourceAsStream("sample_charset.eml"));
        ExtractObject object = new ExtractObject(1L, "eml", StringUtils.EMPTY).setData(data);
