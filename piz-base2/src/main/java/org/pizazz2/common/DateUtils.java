...
public class DateUtils {
	...
	public static Date parse(String time, String pattern) throws ValidateException, UtilityException {
		...
		try {
			...
			throw new UtilityException(BasicCodeEnum.MSG_0017, msg, e);
		}
	}

	public static LocalDateTime parse(String time, DateTimeFormatter formatter) throws ValidateException, UtilityException {
