...
public class NetworkUtils {
	...
	public static InetAddress[] getAddressByNetwork(NetworkEnum.Inet type) throws BaseException {
	...
	public static String[] getHostByNetwork(NetworkEnum.Inet type, String... filter) throws BaseException {
	...
	public static byte[] getMACAddress(InetAddress address) throws BaseException {
		...
		try {
			...
			String _msg = LocaleHelper.toLocaleText(TypeEnum.BASIC, "ERR.SOCKET.NETWORK", address.toString(), e.getMessage());
			throw new BaseException(BasicCodeEnum.MSG_0016, _msg, e);
		}
	}
	...
	public static int ip2Int(String ip) throws BaseException {
	...
	public static long ip2Long(String target) throws BaseException {
	 ...
	 */
	public static NetworkEnum.IpAddressType getIpAddressTypeByIP4(String ip) throws BaseException {
